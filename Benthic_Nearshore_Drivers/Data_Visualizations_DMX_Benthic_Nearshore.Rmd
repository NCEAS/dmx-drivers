...
Plot data presence for all Regions, all Sites: 
```{r, include=FALSE, fig.height=12, fig.width=12}
...
Plot data presence only Regions WPWS, KEFJ, KATM:
```{r, include=FALSE, fig.height=12, fig.width=12}
