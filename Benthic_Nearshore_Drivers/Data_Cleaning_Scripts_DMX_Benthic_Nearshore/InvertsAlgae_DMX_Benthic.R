...
No_IA <- PerCovCalc(No_IA_1, "Neo_sp_Per_Cov") ; No_IA  # call the function
...
ephm_IA <- PerCovCalc(ephm_IA_1, "ephemeral_algae_Per_Cov") ; ephm_IA  # call the function
