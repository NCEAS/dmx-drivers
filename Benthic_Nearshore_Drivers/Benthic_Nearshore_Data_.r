...
BenNear <- merge(BenNear,BAann_IA,all.x=T)       # Brown Algae Annual
BenNear <- merge(BenNear,GAann_IA,all.x=T)       # Green Algae Annual
BenNear <- merge(BenNear,RAann_IA,all.x=T)       # Red Algae Annual
BenNear <- merge(BenNear,RAper_IA,all.x=T)       # Red Algae Perennial
