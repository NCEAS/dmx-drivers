...
BenNear <- data.frame('Site_Name'=c("Aialik Bay","Amalik Bay","Bettles Bay","Cedar Bay",
...
BenNear <- BenNear %>% 
           mutate(Region = ifelse((Site_Name %in% c("Galena Bay","Observation Island",
                           ...
                           ifelse((Site_Name %in% c("Disk Island","Herring Bay",
                                                    "Herring Bay- Bear Cove",
                                                    "Herring Bay- Southwest",
...
BenNear <- BenNear[rep(seq_len(nrow(BenNear)), Year), ]
