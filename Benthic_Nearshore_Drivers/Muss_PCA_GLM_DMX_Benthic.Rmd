...
Sce_18_s_r <- data_sub_model_run(orig_df=BenNear_reg_cpa, select_cols=BenNear_site_cpa_sub2f18)
#Sce_18_s
Sce_18_s_r$aic
...
```{r, echo=FALSE}
# copy the best model outside the function so can do correlation comparison
BenNear_site_cpa_sub2f182 <- BenNear_site_cpa %>% select_(.dots=BenNear_site_cpa_sub2f18)
Sce_18_sa <- glm(mussel_Anom ~ ., data=BenNear_site_cpa_sub2f182, family=gaussian)

# For Scenario Winner
prob3 <- predict(Sce_18_sa, BenNear_site_cpa_sub2f182)
...
BenNear_site_cpa_sub2f18_t <- c("mussel_Anom", "log_TotChlA_micgL_AnnMn", "FWDisc_MeanYearly_ft3s1",
                                "Hobo_WaterTemp_AnnMn", "Bare_Sub_Per_Cov", "UpWelAnom_anul_mn"
                                )

Sce_18_t_s <- data_sub_model_run(orig_df=BenNear_tran_cpa, select_cols=BenNear_site_cpa_sub2f18_t)
#Sce_18_t_s
Sce_18_t_s$aic
