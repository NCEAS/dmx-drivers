...
Sce_15_Site <- data_sub_model_run(orig_df=BenNear_reg_cpa, select_cols=BenNear_site_cpa_sub215_r)
Sce_15_Site
...
Sce_12_Trans <- data_sub_model_run(orig_df=BenNear_reg_cpa, select_cols=BenNear_tran_cpa_sub2l12_r)
Sce_12_Trans
...
BenNear_site_cpa_sub <- BenNear_site_cpa %>%
                        select(mussel_Anom,
                               log_TotChlA_micgL_AnnMn, LAG_FWDisc_MeanYearly_ft3s1, 
                               FWDisc_MeanYearly_ft3s1,
                               UpWelAnom_anul_mn, ENSO_anul_mn, NPGO_anul_mn, PDO_anul_mn, 
                               Hobo_WaterTemp_AnnMn, SOtt_AnnMnEngRec, 
...
BenNear_site_cpa_sub2pl <- BenNear_site_cpa %>% 
                           select(-Year, -Region,  -Site_Name, -log_mussel_Per_Cov, 
                                  ...
                                  -TotChlA_micgL_FlMn, -log_TotChlA_micgL_FlMn, 
                                  -ENSO_spr_mn, -ENSO_fal_mn, -PDO_spring_mn, -PDO_winter_mn, 
                                  -Red_alg_ann_Per_Cov, -WaterTmp_WinterAnom,
                                  -PDO_anul_mn, -LAG_log_TotChlA_micgL_AnnMn
                                  )
...
BenNear_site_cpa_sub2al <- BenNear_site_cpa %>%
                         select(mussel_Anom, log_TotChlA_micgL_AnnMn, LAG_FWDisc_MeanYearly_ft3s1,
                                Bare_Sub_Per_Cov, NPGO_anul_mn, Fuc_dist_Per_Cov
                                )
...
AIC(al_glm_s, al_glm_l_s, al_glm_pl_s, al_glm2_s, al_glm2_l_s, al_glm3_s, al_glm3b_s, 
    al_glm3bt_s, al_glm3bw_s, al_glm3e_s, al_glm3wt_s, 
    site_glm3f, site_glm3fg, site_glm3fh, site_glm3f16, site_glm3f17, site_glm3f18,  
    site_glm3f19, site_glm3f20, site_glm321, site_glm322, site_glm323, al_glm_l12_s)
