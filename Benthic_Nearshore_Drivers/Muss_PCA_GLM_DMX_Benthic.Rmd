...
# 
pca_tran <- prcomp(~., data=BenNear_tran_cpa[,-c(1,2,3,36,39)], na.action=na.omit, scale=TRUE)
#print(pca_cpa) # shows SDs and weightings
summary(pca_tran)
...
# Plotting
pca_tran_all <- autoplot(prcomp(BenNear_tran_cpa[,-c(1,2,3,12,13,16,36,39,40,37)], scale=TRUE),
