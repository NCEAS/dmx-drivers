...
library(randomForest) ; library(plyr) ; library(dplyr) ; library(psych) ; library(nlme) ; library(ggplot2) ; library(AICcmodavg) ; library(stats) ; library(ggfortify) ; library(devtools)
...
pca_reg_cli <- autoplot(prcomp(BenNear_reg_pca[,2:7]), data=BenNear_reg_pca, color='Region')
