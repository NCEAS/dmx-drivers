...
ggplot(data=df33b, aes(prob2b, mussel_Anom, color=Region)) + geom_point(size=4)
...
ggplot(data=df33c, aes(prob2c, mussel_Anom, color=Region)) + geom_point(size=4)
...
ggplot(data=df33d, aes(prob2d, mussel_Anom, color=Region)) + geom_point(size=4)
...
ggplot(data=df33e, aes(prob2e, mussel_Anom, color=Region)) + geom_point(size=4)
...
egg::ggarrange(plots=list(fig2b, fig2a, fig2c, fig2e, fig2d, fig2f, fig2g), 
...
ggplot(data=df333a, aes(prob3a, mussel_Anom, color=Region)) + geom_point(size=4)
...
ggplot(data=df333b, aes(prob3b, mussel_Anom, color=Region)) + geom_point(size=4)
...
ggplot(data=df333c, aes(prob3c, mussel_Anom, color=Region)) + geom_point(size=4)
...
ggplot(data=df335a, aes(prob5a, mussel_Anom, color=Site_Name)) + geom_point(size=3)
