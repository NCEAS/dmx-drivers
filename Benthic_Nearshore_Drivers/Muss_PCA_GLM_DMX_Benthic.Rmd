...
```{r, echo=FALSE}
# Run the PCA
pca_cpa <- prcomp(~., data=BenNear_reg_cpa[,c(3:36)], na.action=na.omit, scale=TRUE)
...
```{r, echo=FALSE}
# Plotting
pca_reg_all <- autoplot(prcomp(BenNear_reg_cpa[,c(3:36)], scale=TRUE), data=BenNear_reg_cpa,
