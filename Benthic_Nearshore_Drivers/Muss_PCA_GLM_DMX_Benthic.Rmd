...
```{r, echo=FALSE}
# Run the PCA
pca_cpa <- prcomp(~., data=BenNear_reg_cpa[,-c(1,2,15,16,38)], na.action=na.omit, scale=TRUE)
...
```{r, echo=FALSE}
# Plotting
pca_reg_all <- autoplot(prcomp(BenNear_reg_cpa[,-c(1,2,15,16,38)], scale=TRUE),
...
BenNear_reg_cpa_sub <- c("mussel_Anom", "log_TotChlA_micgL_AnnMn", "FWDisc_MeanYearly_ft3s1",
                         "WaterTmp_C_AnnMn","UpWelAnom_anul_mn", "ENSO_anul_mn", "NPGO_anul_mn", 
...
BenNear_reg_cpa_sub2bb <- c("mussel_Anom", "log_TotChlA_micgL_AnnMn", "FWDisc_MeanYearly_ft3s1",
                            "NPGO_anul_mn", "WaterTmp_C_AnnMn", "ENSO_anul_mn", "Fuc_dist_Per_Cov",
...
BenNear_reg_cpa_sub2e <- c("mussel_Anom", "log_TotChlA_micgL_AnnMn", "FWDisc_MeanYearly_ft3s1",
                           "NPGO_anul_mn", "WaterTmp_C_AnnMn", "Fuc_dist_Per_Cov",
                           "Red_alg_per_Per_Cov", "Bare_Sub_Per_Cov", "UpWelAnom_anul_mn"
                           )
...
BenNear_reg_cpa_sub2f <- c("mussel_Anom", "log_TotChlA_micgL_AnnMn", "FWDisc_MeanYearly_ft3s1",
                           "NPGO_anul_mn", "WaterTmp_C_AnnMn", "Red_alg_per_Per_Cov", 
                           "Bare_Sub_Per_Cov", "UpWelAnom_anul_mn"
                           )
...
BenNear_reg_cpa_sub14 <- c("mussel_Anom", "log_TotChlA_micgL_AnnMn", "NPGO_anul_mn", 
                           "WaterTmp_C_AnnMn", "Red_alg_per_Per_Cov",
                           "Bare_Sub_Per_Cov", "UpWelAnom_anul_mn"
                           )
...
BenNear_reg_cpa_sub16 <- c("mussel_Anom", "log_TotChlA_micgL_AnnMn", "FWDisc_MeanYearly_ft3s1",
                           "NPGO_anul_mn", "WaterTmp_C_AnnMn", "Red_alg_TOT_Per_Cov",
                           "Bare_Sub_Per_Cov", "UpWelAnom_anul_mn"
                           )
...
Site_list_names <- c("Sce_1_s", "Sce_2_s", "Sce_3_s", "Sce_4_s", "Sce_5_s", "Sce_6_s", "Sce_7_s",
                     ...
                     "Sce_21_s", "Sce_22_s", "Sce_23_s", "Sce_12t_s")
...
# 
pca_tran <- prcomp(~., data=BenNear_tran_cpa[,-c(1,2,3,4,37,40,42)], na.action=na.omit, scale=TRUE)
#print(pca_cpa) # shows SDs and weightings
summary(pca_tran)
...
# Plotting
pca_tran_all <- autoplot(prcomp(BenNear_tran_cpa[,-c(1,2,3,4,17,18,40,42)], scale=TRUE),
...
BenNear_tran_cpa_sub <- c("mussel_Anom", "log_TotChlA_micgL_AnnMn",  "PDO_anul_mn", 
                          "log_TotChlA_micgL_FlMn", "UpWelAnom_fal_mn", "UpWelAnom_spr_mn",
...
##### Scenario 2 - Transect      kitchen sink
```{r, echo=FALSE}

BenNear_tran_cpa_sub2 <- c("-Year", "-Region", "-Site_Name", "-Quadrat", "-log_mussel_Per_Cov",
                           "-UpWelAnom_fal_mn", "-UpWelAnom_spr_mn", "-TotChlA_micgL_FlMn", 
                           "-log_TotChlA_micgL_FlMn", "-ENSO_spr_mn", "-ENSO_fal_mn", 
                           "-PDO_spring_mn", "-PDO_winter_mn", "-WaterTmp_C_Winter", 
                           "-WaterTmp_WinterAnom", "-Red_alg_ann_Per_Cov", "-PDO_anul_mn",
                           "-LAG_log_TotChlA_micgL_AnnMn"
                           )
...
BenNear_tran_cpa_sub2l <- c("mussel_Anom", "log_TotChlA_micgL_AnnMn",  "PDO_anul_mn", 
                            "log_TotChlA_micgL_FlMn", "FWDisc_MeanYearly_ft3s1", "UpWelAnom_fal_mn",
...
BenNear_tran_cpa_sub2l4 <- c("mussel_Anom", "log_TotChlA_micgL_AnnMn", "log_TotChlA_micgL_FlMn", 
                             "FWDisc_MeanYearly_ft3s1", "UpWelAnom_fal_mn", "SOtt_AnnMnEngRec", 
                             "NPGO_anul_mn", "UpWelAnom_anul_mn", "WaterTmp_C_AnnMn", 
                             "Fuc_dist_Per_Cov", "Neo_Odon_sp_Per_Cov", "Red_alg_TOT_Per_Cov", 
                             "BLOYAdult_breed_n", "Bare_Sub_Per_Cov", "Brwn_alg_ann_Per_Cov", 
                             "Whelk_Sum_n_m2", "Green_alg_ann_Per_Cov", "barnacle_Per_Cov"
                             )
...
BenNear_tran_cpa_sub2l6 <- c("mussel_Anom", "log_TotChlA_micgL_FlMn", "FWDisc_MeanYearly_ft3s1", 
                             "NPGO_anul_mn", "Fuc_dist_Per_Cov", "BLOYAdult_breed_n", 
                             "Bare_Sub_Per_Cov", "Green_alg_ann_Per_Cov"
                             )
...
BenNear_tran_cpa_sub2l7 <- c("mussel_Anom", "log_TotChlA_micgL_FlMn", "FWDisc_MeanYearly_ft3s1",
                             "NPGO_anul_mn", "BLOYAdult_breed_n", "Bare_Sub_Per_Cov",
                             "Brwn_alg_ann_Per_Cov", "Green_alg_ann_Per_Cov", "Whelk_Sum_n_m2"
                             )
...
BenNear_tran_cpa_sub2l11 <- c("mussel_Anom", "log_TotChlA_micgL_FlMn", "UpWelAnom_fal_mn",
                              "FWDisc_MeanYearly_ft3s1", "SOtt_AnnMnEngRec", "NPGO_anul_mn",
                              "Hobo_WaterTemp_AnnMn", "Fuc_dist_Per_Cov", "Neo_Odon_sp_Per_Cov", 
                              "Red_alg_TOT_Per_Cov", "BLOYAdult_breed_n", "Bare_Sub_Per_Cov",
                              "Brwn_alg_ann_Per_Cov", "Green_alg_ann_Per_Cov", "barnacle_Per_Cov"
                              )
...
BenNear_tran_cpa_sub2l14 <- c("mussel_Anom", "log_TotChlA_micgL_FlMn", "SOtt_AnnMnEngRec", 
                              "Fuc_dist_Per_Cov", "Neo_Odon_sp_Per_Cov", "Red_alg_TOT_Per_Cov",
                              "BLOYAdult_breed_n", "Bare_Sub_Per_Cov", "Brwn_alg_ann_Per_Cov",
                              "Whelk_Sum_n_m2", "Green_alg_ann_Per_Cov", "barnacle_Per_Cov"
                              )
...
BenNear_tran_cpa_sub2l15 <- c("mussel_Anom", "log_TotChlA_micgL_FlMn", "SOtt_AnnMnEngRec",
                              "BLOYAdult_breed_n", "Bare_Sub_Per_Cov", "Brwn_alg_ann_Per_Cov",
                              "Whelk_Sum_n_m2", "barnacle_Per_Cov"
                              )
...
BenNear_tran_cpa_sub2l16 <- c("mussel_Anom", "log_TotChlA_micgL_FlMn", "SOtt_AnnMnEngRec", 
                              "Bare_Sub_Per_Cov",  "Brwn_alg_ann_Per_Cov", "Whelk_Sum_n_m2", 
                              "barnacle_Per_Cov"
                              )
...
BenNear_tran_cpa_sub2l17 <- c("mussel_Anom", "log_TotChlA_micgL_FlMn", "FWDisc_MeanYearly_ft3s1", 
                              "SOtt_AnnMnEngRec", "NPGO_anul_mn", "BLOYAdult_breed_n",
                              "Bare_Sub_Per_Cov", "Brwn_alg_ann_Per_Cov", "Green_alg_ann_Per_Cov"
                              )
...
BenNear_tran_cpa_sub2l18 <- c("mussel_Anom", "log_TotChlA_micgL_FlMn", "Hobo_WaterTemp_AnnMn", 
                              "SOtt_AnnMnEngRec", "NPGO_anul_mn", "BLOYAdult_breed_n", 
                              "Bare_Sub_Per_Cov", "Brwn_alg_ann_Per_Cov", "Green_alg_ann_Per_Cov"
                              )
...
BenNear_tran_cpa_sub2l19 <- c("mussel_Anom", "log_TotChlA_micgL_FlMn", "SOtt_AnnMnEngRec", 
                              "FWDisc_MeanYearly_ft3s1", "Bare_Sub_Per_Cov", "Brwn_alg_ann_Per_Cov", 
                              "Whelk_Sum_n_m2", "barnacle_Per_Cov"
                              )
...
BenNear_tran_cpa_sub2l20 <- c("mussel_Anom", "log_TotChlA_micgL_FlMn", "SOtt_AnnMnEngRec",
                              "FWDisc_MeanYearly_ft3s1", "Bare_Sub_Per_Cov", "NPGO_anul_mn",
                              "Brwn_alg_ann_Per_Cov", "Whelk_Sum_n_m2", "barnacle_Per_Cov"
                              )
...
BenNear_tran_cpa_sub2l21 <- c("mussel_Anom", "log_TotChlA_micgL_FlMn", "SOtt_AnnMnEngRec", 
...
BenNear_tran_cpa_sub2l22 <- c("mussel_Anom", "log_TotChlA_micgL_FlMn", "FWDisc_MeanYearly_ft3s1",
                              "NPGO_anul_mn", "Hobo_WaterTemp_AnnMn", "BLOYAdult_breed_n",
                              "Bare_Sub_Per_Cov", "Brwn_alg_ann_Per_Cov"
                              )
...
BenNear_tran_cpa_sub2l23 <- c("mussel_Anom", "LAG_log_TotChlA_micgL_FlMn", "FWDisc_MeanYearly_ft3s1",
                              "NPGO_anul_mn", "Hobo_WaterTemp_AnnMn", "BLOYAdult_breed_n",
                              "Bare_Sub_Per_Cov", "Brwn_alg_ann_Per_Cov"
                              )
...
BenNear_tran_cpa_sub2l25 <- c("mussel_Anom", "log_TotChlA_micgL_AnnMn", "FWDisc_MeanYearly_ft3s1", 
                              "SOtt_AnnMnEngRec", "NPGO_anul_mn", "Hobo_WaterTemp_AnnMn", 
                              "BLOYAdult_breed_n", "Bare_Sub_Per_Cov", "Brwn_alg_ann_Per_Cov", 
                              "Green_alg_ann_Per_Cov"
                              )
...
Tran_list_names <- c("Sce_1_t", "Sce_2_t", "Sce_3_t", "Sce_4_t", "Sce_5_t", "Sce_6_t", "Sce_7_t", 
                     ...
                     "Sce_22_t", "Sce_23_t", "Sce_24_t", "Sce_25_t")
...
##### Scenario 13 - Transect     Winner from Region-level analysis above
```{r, echo=FALSE}

BenNear_reg_cpa_sub2f_t <- c("mussel_Anom", "log_TotChlA_micgL_AnnMn", "FWDisc_MeanYearly_ft3s1",
                             "NPGO_anul_mn", "Hobo_WaterTemp_AnnMn", "Red_alg_per_Per_Cov", 
                             "Bare_Sub_Per_Cov", "UpWelAnom_anul_mn"
                             )

Sce_13_t_r <- data_sub_model_run(orig_df=BenNear_tran_cpa, select_cols=BenNear_reg_cpa_sub2f_t)
#Sce_13_t_r

```

##### Scenario 15 - Transect      Winner from Site-level analysis above
```{r, echo=FALSE}

BenNear_site_cpa_sub215_t <- c("mussel_Anom", "log_TotChlA_micgL_AnnMn", "FWDisc_MeanYearly_ft3s1",
                               "NPGO_anul_mn", "Bare_Sub_Per_Cov", "UpWelAnom_anul_mn"
                               )

Sce_15_t_s <- data_sub_model_run(orig_df=BenNear_tran_cpa, select_cols=BenNear_site_cpa_sub215_t)
#Sce_15_t_s

```

##### Scenario 22 (15 plus preds) - Transect     Co-winner from Site-level analysis above
```{r, echo=FALSE}

BenNear_tran_cpa_sub222_t <- c("mussel_Anom", "log_TotChlA_micgL_AnnMn", "FWDisc_MeanYearly_ft3s1",
                               "NPGO_anul_mn", "Bare_Sub_Per_Cov", "UpWelAnom_anul_mn",
                               "BLOYAdult_breed_n"
                               )

Sce_22_t_s <- data_sub_model_run(orig_df=BenNear_tran_cpa, select_cols=BenNear_tran_cpa_sub222_t)
#Sce_22_t_s
