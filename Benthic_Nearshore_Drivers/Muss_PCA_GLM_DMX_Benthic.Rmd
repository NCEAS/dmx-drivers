...
# Comparing Scenario 15 from the Site-level mode fitting exercise
...
# 
pca_site <- prcomp(~., data=BenNear_site_cpa[,-c(1,2,3,24,25,36,39)], na.action=na.omit, scale=TRUE)
#print(pca_cpa) # shows SDs and weightings
summary(pca_site)
...
# Plotting
pca_site_all <- autoplot(prcomp(BenNear_site_cpa[,-c(1,2,3,12,13,24,25,36,39)], scale=TRUE),
...
# 
pca_tran <- prcomp(~., data=BenNear_tran_cpa[,-c(1,2,3,24,25,36,39)], na.action=na.omit, scale=TRUE)
#print(pca_cpa) # shows SDs and weightings
summary(pca_tran)
...
# Plotting
pca_tran_all <- autoplot(prcomp(BenNear_tran_cpa[,-c(1,2,3,12,13,24,25,36,39)], scale=TRUE),
...
# Scenario 15 from Site-level analysis above
##### Scenario 15  
...
df335 <- cbind(BenNear_tran_cpa[,c(1,2,3,39)], prob5)

qplot(data=df335, prob5, mussel_Anom, color=Site_Name, size=3)
cor(prob5, BenNear_tran_cpa[,39])
#cor(BenNear_reg_cpa_sub2a[,1], BenNear_reg_cpa_sub2a[,3])
